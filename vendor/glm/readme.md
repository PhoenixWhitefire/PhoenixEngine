...
```c++
#include <thirdparty/glm/vec3.hpp> // glm::vec3
#include <thirdparty/glm/vec4.hpp> // glm::vec4
#include <thirdparty/glm/mat4x4.hpp> // glm::mat4
#include <thirdparty/glm/gtc/matrix_transform.hpp> // glm::translate, glm::rotate, glm::scale, glm::perspective
#include <thirdparty/glm/gtc/constants.hpp> // glm::pi
...
- Added <thirdparty/glm/gtx/hash.hpp> to perform std::hash on GLM types #320 #367
- Added <thirdparty/glm/gtx/wrap.hpp> for texcoord wrapping
...
- Fixed GLM_FORCE_RADIANS with <thirdparty/glm/ext.hpp> build error (#165)
